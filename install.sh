...
sed -i 's/password_here/!didqocn12/g' /var/www/html/wp-config.php
#sed -i 's/localhost/mydb.cbnbkh3unm6b.ap-northeast-1.rds.amazonaws.com/g' /var/www/html/wp-config.php
sed -i 's/localhost/mydb.c3fcd1cau0zt.ap-northeast-2.rds.amazonaws.com/g' /var/www/html/wp-config.php
